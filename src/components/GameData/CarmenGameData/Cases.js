      ...
      steps: [
        {
          city: {
            name: 'Paris',
            description:
              "La France, avec une population de 55 millions d'habitants, est célèbre pour sa gastronomie, ses vins, sa mode et ses arts.",
            img: 'paris.jpg'
          },
          clues: [
            {
        ...
        },
        {
          city: {
            name: 'Tokyo',
            description:
              'Tokyo, la capitale du Japon, est surplombé par le mont Fuji, une des plus belles vues du Japon.',
            img: 'tokyo.jpg'
          },
          clues: [
            {
        ...
        },
        {
          city: {
            name: 'Baghdad',
            description:
              "Il fut un temps, l'Irak s'appelait la Mésopotamie. Aujourd'hui, l'Irak est entouré par la Jordanie, la Syrie, la Turquie, l'Iran, le Koweit and l'Arabie Saoudite.",
            img: 'baghdad.jpg'
          },
          clues: [
            {
        ...
        },
        {
          city: {
            name: 'Cairo',
            description:
              "Le Caire, situé à l'embouchure du Nil est une des plus grandes villes africaines.",
            img: 'cairo.jpg'
          },
          clues: [
            {
