...
const Dossiers = [
  ...
  },
  {
    en: {
      ...
      Miscellaneous:
        "For the past five years, this brunette beauty has been travelling around the world with a mobile health spa to conduct exercise classes for the extremely wealthy.  Rumor has it that this is merely a cover for her criminal activities.  When she isn't pilfering the treasures of the world, Merey can usually be found participating in the good life.  A world class mountain climber, she has a mania for fancy jewelry and spicy foods.  Her favourite mode of travel is in the back of a fancy limousine where she can relax and plot her next job.",
      hair: 'Black',
      hobby: 'Climber',
      vehicule: 'Limousine',
      feature: 'Jewelry',
  ...
  },
  {
    en: {
      ...
      sex: 'Female',
      Occupation:
        'A colorful character with a predilection for sensible shoes, Lady Agatha is a reader of mystery stories set in upper-class English drawing rooms.',
      Miscellaneous:
  ...
  },
  {
    en: {
      ...
      sex: 'Male',
      Occupation:
        'Pretender to the Czarist throne and a lot of other things, too.  Ihorovitch has an amazing ability to disappear from sight for varying amounts of time.',
      Miscellaneous:
        "He seems to have a great fascination for very large marsupials.  A likeable brute, Ihorovitch provides an additional hand for the mob's nefarious activities.  Blond and sporting a strange Ukranian tattoo, he has been known to eat the contents of an entire lobster tank by himself.  Ihorovitch has a color television set installed in his limousine so he doesn't have to miss the Saturday morning cartoon shows.",
      hair: 'Blond',
      hobby: 'Croquet',
      vehicule: 'Limousine',
